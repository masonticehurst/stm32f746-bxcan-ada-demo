...
package GUI is
   ...
   type Pages is (Status_Page, Control_Page, Capture_Page);
   ...
   Max_Buttons : constant := 16;
   type Button_Callback is access procedure;
   type Button_Callback_Array is array (Positive range <>) of Button_Callback;
   ...
   Last_Accel_Pedal_Position_Percent : Natural := 9_999;
   Last_State_Of_Charge_Percent      : Natural := 9_999;
   ...
   procedure Status_Page_Init;
   procedure Status_Page_Tick;
   procedure Status_Button_Callback;
